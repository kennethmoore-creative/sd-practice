...
```{r deer pop, echo=FALSE, fig.align = 'center', out.width = "50%", fig.cap = "**births = deer population * birth fraction**"}
knitr::include_graphics(here::here("sd_model_examples", "images/first-order-deer-pop.jpg"))
```
...
```{r interest, echo=FALSE, fig.align = 'center', out.width = "50%", fig.cap = "**interest earned = bank balance * interest rate**"}
knitr::include_graphics(here::here("sd_model_examples", "images/first-order-interest-rate.jpg"))
```
...
```{r knowledge, echo=FALSE, fig.align = 'center', out.width = "50%", fig.cap = "**learning = knowledge/time to learn**"}
knitr::include_graphics(here::here("sd_model_examples", "images/first-order-knowledge.jpg"))
```
